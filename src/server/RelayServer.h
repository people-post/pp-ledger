...
private:
  ...
  static constexpr uint16_t DEFAULT_RELAY_PORT = 8519;

  // RunFileConfig can be autogenerated to help users understand the configuration file format.
  ...
  struct NetworkConfig {
    uint16_t udp_port{DEFAULT_RELAY_PORT};
    std::vector<std::string> privateKeys;
    std::string beacon_multiaddr;
  };
