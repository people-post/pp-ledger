...
void ConsoleHandler::emit(Level level, const std::string& loggerName, const std::string& message) {
    if (level < level_) {
        return;
    }
...
void FileHandler::emit(Level level, const std::string& loggerName, const std::string& message) {
    if (level < level_) {
        return;
    }
    if (file_.is_open()) {
