...
public:
    ...
    // Request types
    // Client to Server
    static constexpr const uint16_t T_REQ_INFO = 1001; // Request information about the server
    static constexpr const uint16_t T_REQ_QUERY_WALLET = 1002; // Request information about wallet
    static constexpr const uint16_t T_REQ_ADD_TRANSACTION = 1003; // Request add transaction

    // Server to Beacon
    static constexpr const uint16_t T_REQ_BEACON_VALIDATORS = 2001; // Request validators from beacon

    // Server to Server
    static constexpr const uint16_t T_REQ_BLOCKS = 3001; // Request blocks from the server
    static constexpr const uint16_t T_REQ_PEER_VALIDATORS = 3002; // Request validators from peer server
    ...
    static constexpr const uint16_t E_INVALID_TRANSACTION = 10; // Invalid transaction
    static constexpr const uint16_t E_INVALID_VALIDATOR = 11; // Invalid validator
    static constexpr const uint16_t E_INVALID_BLOCKCHAIN = 12; // Invalid blockchain
